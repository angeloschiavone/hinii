...
public class TabsUtil4 {
	...
	public static void addNativeLookingTab(Context context,
			final TabHost tabHost, View tabView) {

		// Since we're using a custom view, we need to manually set the colors
		// of the focused
	...
	private static void setNativeLookingTabTextColor(View view, int ourIndex,
			int selectedIndex) {
