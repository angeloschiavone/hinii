 ...
 * from CheckinExecuteActivity. It would be nicer to put this in another
 * activity, but right now the CheckinResult is quite large and would require a
 * good amount of work to add serializers for all its inner classes. This
 * wouldn't be a huge problem, but maintaining it as the classes evolve could
...
public class WebViewDialog extends Dialog {
	...
	/**
	 * Force-inflates a dialog main linear-layout to take max available screen
	 * space even though contents might not occupy full screen size.
	 */
	public static void inflateDialog(LinearLayout layout) {
		WindowManager wm = (WindowManager) layout.getContext()
